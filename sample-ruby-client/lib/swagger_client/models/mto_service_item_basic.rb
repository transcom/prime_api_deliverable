...
module SwaggerClient
  ...
  class MTOServiceItemBasic
    ...
    def hash
      [id, move_task_order_id, mto_shipment_id, re_service_id, re_service_name, status, rejection_reason, model_type, e_tag, re_service_code].hash
    end
