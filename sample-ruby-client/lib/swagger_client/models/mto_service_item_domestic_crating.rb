...
module SwaggerClient
  ...
  class MTOServiceItemDomesticCrating
    attr_accessor :id
    ...
    def self.swagger_types
      {
        ...
        :'item' => :'MTOServiceItemDimension',
        :'crate' => :'MTOServiceItemDimension',
        :'description' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'crate')
        self.crate = attributes[:'crate']
      end
    ...
    def list_invalid_properties
      ...
      if @crate.nil?
        invalid_properties.push('invalid value for "crate", crate cannot be nil.')
      end
    ...
    def valid?
      ...
      re_service_code_validator = EnumAttributeValidator.new('String', ['DCRT', 'DCRTSA', 'DUCRT'])
      return false unless re_service_code_validator.valid?(@re_service_code)
      return false if @item.nil?
      return false if @crate.nil?
    ...
    def re_service_code=(re_service_code)
      validator = EnumAttributeValidator.new('String', ['DCRT', 'DCRTSA', 'DUCRT'])
    ...
    def hash
      [id, move_task_order_id, mto_shipment_id, re_service_id, re_service_name, status, rejection_reason, model_type, e_tag, re_service_code, item, crate, description].hash
    end
