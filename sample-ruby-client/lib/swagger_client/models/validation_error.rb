...
module SwaggerClient
  class ValidationError
    ...
    def self.swagger_types
      {
        ...
        :'detail' => :'String',
        :'instance' => :'String',
        :'invalid_fields' => :'Hash<String, String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invalidFields')
        if (value = attributes[:'invalidFields']).is_a?(Hash)
    ...
    def hash
      [title, detail, instance, invalid_fields].hash
    end
