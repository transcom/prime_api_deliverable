...
module SwaggerClient
  class MoveOrder
    ...
    def self.swagger_types
      {
        ...
        :'destination_duty_station' => :'DutyStation',
        :'origin_duty_station' => :'DutyStation',
        :'rank' => :'String',
        :'report_by_date' => :'Date',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reportByDate')
        self.report_by_date = attributes[:'reportByDate']
      end

      if attributes.has_key?(:'confirmationNumber')
        self.confirmation_number = attributes[:'confirmationNumber']
      end
      ...
      if attributes.has_key?(:'linesOfAccounting')
        self.lines_of_accounting = attributes[:'linesOfAccounting']
      end
    ...
    def hash
      [id, customer, customer_id, entitlement, destination_duty_station, origin_duty_station, rank, report_by_date, confirmation_number, order_number, lines_of_accounting, e_tag].hash
    end
