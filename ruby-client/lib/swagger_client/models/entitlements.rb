...
module SwaggerClient
  class Entitlements
    attr_accessor :total_weight_self
    ...
    def self.attribute_map
      {
        :'total_weight_self' => :'totalWeightSelf',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalWeightSelf')
        self.total_weight_self = attributes[:'totalWeightSelf']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          total_weight_self == o.total_weight_self &&
    ...
    def hash
      [total_weight_self, dependents_authorized, total_dependents, pro_gear_weight, pro_gear_weight_spouse, non_temporary_storage, privately_owned_vehicle, storage_in_transit].hash
    end
